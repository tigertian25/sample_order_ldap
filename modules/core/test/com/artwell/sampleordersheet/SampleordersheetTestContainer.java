package com.artwell.sampleordersheet;
...
public class SampleordersheetTestContainer extends TestContainer {

    public SampleordersheetTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/artwell/sampleordersheet/app.properties",
    ...
    public static class Common extends SampleordersheetTestContainer {

        public static final SampleordersheetTestContainer.Common INSTANCE = new SampleordersheetTestContainer.Common();
